...
const features = [
  ...
  { icon: BarChart3, title: "סטטיסטיקות ותובנות", desc: "אחוזי נוכחות, רצפי ימים, מגמות שבועיות, החודש המצטיין (לפי לוח עברי) ותובנות חכמות אוטומטיות." },
  { icon: History, title: "היסטוריה מלאה", desc: "טבלה עם סינון, חיפוש ותצוגת לוח שנה משולבת של כל הרישומים." },
  { icon: FileText, title: "הפקת דוחות", desc: "יצוא דוחות מעוצבים ב-PDF (עם תמיכה מלאה בעברית ו-RTL) ובאקסל." },
