...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BsU3d7rr.mjs");
...
const manifest = {
  "8b42bb4332a2cf93f09a94255696b6a6435303e98ac657d3cbe2765ef63c1cbf": {
    ...
    importer: () => import("./download-source.functions-CdUKS4oD.mjs")
  }
};
